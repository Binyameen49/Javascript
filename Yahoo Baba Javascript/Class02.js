...
// 1- Variable are just like containers that Containe or Stores data in it.

// Data can be of multiple types such as

// 1- Number form data (Integer + float) i.e: 2, 2.3
// 2- Character form data i.e: 'a', '1'
...
let num2;       // let called variable declarator
num2 = 45;      // let num1 called variable declaration
