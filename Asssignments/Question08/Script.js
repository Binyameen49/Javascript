...
if (char01 === 'a' || char01 === 'b' || char01 === 'c' || char01 === 'd' || char01 === 'e' ||
    ...
    char01 === 'z') {
    alert(`${char01} is a Lower-Case-Character.`);
    console.log(`${char01} is a Lower-Case-Character.`);
    document.write(`${char01} is a Lower-Case-Character.`);
} else {
    alert(`${char01} is a Upper-Case-Character.`);
    console.log(`${char01} is a Upper-Case-Character.`);
    document.write(`${char01} is a Upper-Case-Character.`);
}